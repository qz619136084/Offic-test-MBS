      ...
      jQuery(".table-widget-container .dropdown-field.time-field").on(
        ...
        function (e) {
          if (!jQuery(this).hasClass("hasCompleted")) {
            e.preventDefault();
            timeLineClicked++;
            makeSlotChanges4383V1(slotCount, timeLineClicked);
...
function makeSlotChanges4383V1(slotCount, timeLineClicked) {
  jQuery(".dropdown-field.time-field").parent().addClass("processing");
    ...
    jQuery.ajax({
      ...
      success: function (res) {
        ...
        if (res.status === "success") {
          ...
          addSelectedSlotAvailability3254V1();
          jQuery(".table-widget-container .dropdown-field.time-field").addClass(
            "hasCompleted"
          );
          if (slotCount == 0 && timeLineClicked != 0) {
            var chkClickIntv = setInterval(function () {
              if (
                !jQuery(".dropdown-field.time-field")
                  .parent()
                  .hasClass("processing")
              ) {
                jQuery(
  ...
  setTimeout(function () {
    jQuery(".dropdown-field.time-field").parent().removeClass("processing");
  }, 1500);
