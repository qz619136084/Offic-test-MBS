$(function () {
  ...
  if (url.indexOf("zh.") > -1) {
    ...
    title = "换领体验活动";
    content =
      "<li> <b>第一步：</b>在任意金沙尊赏柜台领取您的会员卡。 入住时出示您的会员卡，赚取 6% 度假胜地奖赏钱。 </li> <li> <b>第二步：</b>前往任意会员电子站刷您的会员卡。点击“推广游戏”（Promotional Games），选择“金沙悠享宅假”（Sandsational Staycation）换领免费体验活动。 </li> <li><b>第三步：</b>前往对应商家出示打印凭证。</li>";
    videoIframe =
    ...
    title = "兌換體驗活動";
    content =
      "<li> <b>第一步：</b>在任意金沙尊賞櫃檯領取您的會員卡。 入住時出示您的會員卡，賺取 6% 度假勝地獎賞錢。 </li> <li> <b>第二步：</b>前往任意會員電子站刷您的會員卡。點擊「推廣遊戲」（Promotional Games），選擇「金沙悠享宅假」（Sandsational Staycation）兌換免費體驗活動。 </li> <li><b>第三步：</b>前往對應商家出示打印憑證。</li>";
    videoIframe =
    ...
    title = "無料特典";
    content =
      "<li> <b>ステップ1:</b> 最寄りのサンズリワード・カウンターで会員カードをお受け取りください。 チェックインの際に会員カードをご提示いただくと、宿泊料金の6%のリゾートドルが加算されます。 </li> <li> <b>ステップ2:</b> キオスクで会員カードをスワイプします。「Promotional Games」→「Sandsational Staycation」の順にタップして、お好きな無料特典をお選びください。 </li> <li><b>ステップ3:</b> プリントされたバウチャーを各店舗へご提示願います。</li>";
    videoIframe =
    ...
    srlNotice_1 = "샌즈 리워즈 회원 자격으로 이번 예약에서 ";
    srlNotice_2 = " 리조트 달러를 적립하고 호텔 패키지 무료 경험을 사용하세요!";
    title = "경험 사용하기";
    content =
      "<li> <b>1단계:</b> 샌즈 리워즈 카운터에서 멤버십 카드를 수령하세요. 체크인 시 카드를 제시하고 호텔 숙박 요금의 6%를 리조트 달러로 적립합니다. </li> <li> <b>2단계:</b> 멤버십 키오스크에서 카드를 인식시킵니다. ‘프로모션 게임’ -> ‘샌즈세이셔널 스테이케이션’을 탭해서 무료 경험을 사용합니다. </li> <li><b>3단계:</b> 프린트된 바우처를 각 매장에 제시합니다.</li>";
    videoIframe =
      "<iframe class='vidyard_iframe' src='//play.vidyard.com/pfTbaGEYNX7gXvkWiKeEoN.html?' width='640' height='360' scrolling='no' frameborder='0' allowtransparency='true' allowfullscreen></iframe>";
    ...
    content =
      "<li> <b>Step 1:</b> Collect your membership card at any Sands Rewards counter. Present your card upon check-in to earn 6% Resort Dollars with your stay. </li> <li> <b>Step 2:</b> Swipe your card at any membership kiosk. Tap on “Promotional Games” -> “Sandsational Staycation” to redeem your free experiences. </li> <li><b>Step 3:</b> Present your printed vouchers at respective outlets.</li>";
    videoIframe =
      "<iframe class='vidyard_iframe' src='//play.vidyard.com/pfTbaGEYNX7gXvkWiKeEoN.html?' width='640' height='360' scrolling='no' frameborder='0' allowtransparency='true' allowfullscreen></iframe>";
  }
