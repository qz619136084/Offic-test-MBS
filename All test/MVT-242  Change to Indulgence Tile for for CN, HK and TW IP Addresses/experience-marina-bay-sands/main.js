$(function () {
  ...
  $(".swiper-slide:eq(1) .card img").attr({
  ...
  $(".swiper-slide:eq(1) .card .card-title").text(title);
  $(".swiper-slide:eq(1) .card .card-text").text(content);
  $(".swiper-slide:eq(1) .card .card-footer a").attr(
    "href",
