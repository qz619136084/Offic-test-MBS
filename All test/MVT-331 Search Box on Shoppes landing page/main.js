$(function () {
  setTimeout(function () {
    $(".component-section.section:has(.announcement-box)").after(
      "<div class='listing-tools dy-search-box'> <ul class='list-inline text-center'> <li class='list-inline-item'> <input type='text' class='form-control search-filters' placeholder='Search by shop name' /><button> <img width='27' height='27' src='/content/dam/singapore/marinabaysands/master/main/images/DY-MVT-210-Search-Box/search-icon.svg' /> </button> </li> </ul> </div>"
    );
  ...
  function redirect() {
    ...
    if (inputText.length > 0) {
      var targetUrl = "/shopping/store-directory.html?search=" + inputText;
