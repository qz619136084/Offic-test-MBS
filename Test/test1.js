window.checkJq11101429 = setInterval(function () {
  if (typeof $ != "undefined") {
    $(function () {
      /* Data */
      var roomList = [
      ...
      function closeLightbox(eleName) {
        ...
        setTimeout(function () {
          ...
          if (eleName.is($(".dy-roomsComparison-lightbox"))) {
            $(
              ".dy-roomsComparison-lightbox .modal-content .modal-body"
            ).remove();
          }
        }, 150);
      }
      ...
      function adjustTableCss() {
        ...
        for (
          let i = 0;
          i < $(".dy-roomsComparison-lightbox .tb3 tr").length;
          i++
        ) {
          var firstColumn = $(
            ".dy-roomsComparison-lightbox .tb3 tr:eq(" + i + ")"
          );
          var secondColumn = $(
          ...
          if (windowWidth < 500) {
            ...
            var offset =
              $(".dy-roomsComparison-lightbox .modal-body .next-btn").offset()
                .top -
    ...
    clearInterval(window.checkJq11101429);
  }
}, 100);
